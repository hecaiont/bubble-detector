...
class CaptureEngine():
    ...
    def checkArea(self):
        print('checkArea start!')
        self.toOrigin()
        time.sleep(0.5)
        pg.moveTo(self.WindowOriginX+self.WindowWidthSize, self.WindowOriginY)
        time.sleep(0.5)
        pg.moveTo(self.WindowOriginX+self.WindowWidthSize, self.WindowOriginY+self.WindowHeightSize)
        time.sleep(0.5)
        pg.moveTo(self.WindowOriginX, self.WindowOriginY+self.WindowHeightSize)
        print('checkArea end!')

    def baitArea(self, ptx1, ptx2, pty1, pty2):
        self.WindowOriginX = ptx1-100
        self.WindowOriginY = pty1-100
        self.WindowWidth = ptx2+100
        self.WindowHeight = pty2+100

        print(self.WindowOriginX, self.WindowOriginY)
    ...
    def main(self):
        ...
        while self.isCapturable:
            ...
            if self.captureNo == 20:
                # self.isCapturable = False
                print('!')

                self.baitArea(self.ptx1, self.ptx2, self.pty1, self.pty2)
